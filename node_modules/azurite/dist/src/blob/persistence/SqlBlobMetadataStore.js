...
class SqlBlobMetadataStore {
    ...
    async getBlobProperties(context, account, container, blob, snapshot = "", leaseAccessConditions, modifiedAccessConditions) {
        return this.sequelize.transaction(async (t) => {
            ...
            let responds = LeaseFactory_1.default.createLeaseState(new BlobLeaseAdapter_1.default(blobModel), context)
                .validate(new BlobReadLeaseValidator_1.default(leaseAccessConditions))
                .sync(new BlobLeaseSyncer_1.default(blobModel));
            return Object.assign(Object.assign({}, responds), { properties: Object.assign(Object.assign({}, responds.properties), { tagCount: (0, utils_3.getBlobTagsCount)(blobModel.blobTags) }) });
        });
    }
    undeleteBlob() {
    ...
    startCopyFromURL(context, source, destination, copySource, metadata, tier, options = {}) {
        return this.sequelize.transaction(async (t) => {
            ...
            const copiedBlob = {
                ...
                deleted: false,
                snapshot: "",
                properties: Object.assign(Object.assign({}, sourceBlob.properties), { creationTime: context.startTime, lastModified: context.startTime, etag: (0, utils_2.newEtag)(), leaseStatus: destBlob !== undefined
                        ...
                        : undefined, copyId: (0, v4_1.default)(), copyStatus: Models.CopyStatusType.Success, copySource, copyProgress: sourceBlob.properties.contentLength
    ...
    setBlobTag(context, account, container, blob, snapshot, leaseAccessConditions, tags, modifiedAccessConditions) {
        return this.sequelize.transaction(async (t) => {
            ...
            const lastModified = context.startTime || new Date();
            const etag = (0, utils_2.newEtag)();
            await BlobsModel.update(Object.assign({ blobTags: this.serializeModelValue(tags) || null, lastModified,
                etag }, this.convertLeaseToDbModel(new BlobLeaseAdapter_1.default(blobModel))), {
                where: {
                    accountName: account,
                    containerName: container,
