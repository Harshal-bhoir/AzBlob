...
class ContainerHandler extends BaseHandler_1.default {
    constructor(accountDataStore, oauth, metadataStore, extentStore, logger, loose) {
    ...
    async submitBatch(body, contentLength, multipartContentType, options, context) {
        ...
        const blobBatchHandler = new BlobBatchHandler_1.BlobBatchHandler(this.accountDataStore, this.oauth, this.metadataStore, this.extentStore, this.logger, this.loose);
        ...
        const response = {
            ...
            segment: {
                blobItems: blobs.map(item => {
                    return Object.assign(Object.assign({}, item), { deleted: item.deleted !== true ? undefined : true, snapshot: item.snapshot || undefined, blobTags: includeTags ? item.blobTags : undefined, properties: Object.assign(Object.assign({}, item.properties), { etag: (0, utils_2.removeQuotationFromListBlobEtag)(item.properties.etag), tagCount: (0, utils_2.getBlobTagsCount)(item.blobTags), accessTierInferred: item.properties.accessTierInferred === true ? true : undefined }) });
                })
            },
            clientRequestId: options.requestId,
        ...
        const response = {
            ...
            segment: {
                ...
                blobItems: blobItems.map(item => {
                    ...
                    return Object.assign(Object.assign({}, item), { snapshot: item.snapshot || undefined, blobTags: includeTags ? item.blobTags : undefined, properties: Object.assign(Object.assign({}, item.properties), { etag: (0, utils_2.removeQuotationFromListBlobEtag)(item.properties.etag), tagCount: (0, utils_2.getBlobTagsCount)(item.blobTags), accessTierInferred: item.properties.accessTierInferred === true ? true : undefined }) });
                })
            },
            clientRequestId: options.requestId,
            nextMarker: `${nextMarker || ""}`
